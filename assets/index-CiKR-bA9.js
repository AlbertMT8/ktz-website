...
`)+`
`+_);const U=L+S+d,w=L+_+h,F=pv(l,l.VERTEX_SHADER,U),V=pv(l,l.FRAGMENT_SHADER,w);l.attachShader(A,F),l.attachShader(A,V),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function B(G){if(s.debug.checkShaderErrors){const le=l.getProgramInfoLog(A).trim(),re=l.getShaderInfoLog(F).trim(),xe=l.getShaderInfoLog(V).trim();let pe=!0,z=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(pe=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,A,F,V);else{const K=gv(l,F,"vertex"),j=gv(l,V,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
...
`,CR=({className:s="",variation:e=0,pixelRatioProp:i=2,shapeSize:r=1.2,roundness:l=.4,borderSize:u=.05,circleSize:d=.3,circleEdge:h=.5})=>{const m=he.useRef(null);return he.useEffect(()=>{const p=m.current;if(!p)return;let g,x=0,v=0;const M=new Rt,E=new Rt,A=new Rt;let S=1,_=1;const L=new BE,U=new c0;U.position.z=1;const w=new TR({alpha:!0,antialias:!0});w.setClearColor(0,0),p.appendChild(w.domElement);const F=new Jo(1,1),V=new ca({vertexShader:AR,fragmentShader:RR,uniforms:{u_mouse:{value:E},u_resolution:{value:A},u_pixelRatio:{value:i},u_shapeSize:{value:r},u_roundness:{value:l},u_borderSize:{value:u},u_circleSize:{value:d},u_circleEdge:{value:h}},defines:{VAR:e},transparent:!0}),B=new Ri(F,V);L.add(B);const W=le=>{if(!p)return;const re=p.getBoundingClientRect();M.set(le.clientX-re.left,le.clientY-re.top)};document.addEventListener("mousemove",W),document.addEventListener("pointermove",W);const D=()=>{if(!m.current)return;const le=m.current;S=le.clientWidth,_=le.clientHeight;const re=Math.min(window.devicePixelRatio||1,2);w.setSize(S,_),w.setPixelRatio(re),U.left=-S/2,U.right=S/2,U.top=_/2,U.bottom=-_/2,U.updateProjectionMatrix(),B.scale.set(S,_,1),A.set(S,_).multiplyScalar(re),V.uniforms.u_pixelRatio.value=re};D(),window.addEventListener("resize",D);let C=null;typeof ResizeObserver<"u"&&m.current&&(C=new ResizeObserver(()=>D()),C.observe(m.current));const G=()=>{x=performance.now()*.001;const le=x-v;v=x,E.x=P_.damp(E.x,M.x,8,le),E.y=P_.damp(E.y,M.y,8,le),w.render(L,U),g=requestAnimationFrame(G)};return G(),()=>{cancelAnimationFrame(g),window.removeEventListener("resize",D),C&&C.disconnect(),document.removeEventListener("mousemove",W),document.removeEventListener("pointermove",W),p&&w.domElement.parentNode===p&&p.removeChild(w.domElement),w.dispose(),V.dispose(),F.dispose()}},[e,i,r,l,u,d,h]),I.jsx("div",{ref:m,className:`w-full h-full ${s}`})},wR=()=>{const[s,e]=he.useState(1),[i,r]=he.useState(!1);return he.useEffect(()=>{typeof window<"u"&&e(window.devicePixelRatio||1)},[]),I.jsx("div",{className:"flex w-full min-h-screen justify-center items-center bg-black p-4",children:I.jsxs("div",{className:"relative w-[1000px] h-[400px] sm:w-[1200px] sm:h-[500px] md:w-[1400px] md:h-[600px] flex justify-center items-center cursor-pointer",onMouseEnter:()=>r(!0),onMouseLeave:()=>r(!1),children:[I.jsx("div",{className:"absolute inset-0 flex justify-center items-center z-0",children:I.jsx("h1",{className:`
              text-4xl sm:text-5xl font-bold select-none whitespace-nowrap
              transition-colors duration-200 ease-in-out
              ${i?"text-gray-100":"text-gray-400"} 
            `,children:"Redefining Markets Through Math."})}),I.jsx("div",{className:"absolute inset-0 z-10 pointer-events-none",children:I.jsx(CR,{variation:0,pixelRatioProp:s,shapeSize:1,roundness:.5,borderSize:.005,circleEdge:1})})]})})},DR=[{label:"Petabytes data processed",value:"100+"},{label:"AUM",value:"$10B+"},{label:"Proprietary Models",value:"50+"},{label:"PhDs",value:"40+"},{label:"Global Offices",value:"5"},{label:"Years of R&D",value:"20+"}],UR=()=>I.jsxs("div",{className:"bg-white",children:[I.jsx("section",{className:"relative w-full h-screen z-20",children:I.jsx(wR,{})}),I.jsxs("section",{className:"relative bg-gradient-to-r from-blue-900 to-blue-600 text-white min-h-[60vh] flex items-center",children:[I.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-blue-900 to-blue-600 opacity-90"}),I.jsxs("div",{className:"relative z-10 max-w-4xl mx-auto px-6 py-24 text-center",children:[I.jsx("h1",{className:"text-5xl font-extrabold tracking-tight mb-6",children:"Unlocking Alpha Through Data-Driven Innovation"}),I.jsx("p",{className:"text-xl mb-8 max-w-2xl mx-auto",children:"KTZ is a quantitative investment firm leveraging advanced machine learning and big data analytics to deliver superior risk-adjusted returns for institutional investors."}),I.jsx("a",{href:"#contact",className:"inline-block bg-white text-blue-700 font-semibold px-8 py-3 rounded-md shadow hover:bg-blue-100 transition-colors",children:"Get in Touch"})]})]}),I.jsx("section",{className:"bg-white py-16",children:I.jsx("div",{className:"max-w-6xl mx-auto px-4",children:I.jsx("div",{className:"grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-8 text-center",children:DR.map(s=>I.jsxs("div",{className:"",children:[I.jsx("div",{className:"text-3xl font-bold text-blue-700 mb-2",children:s.value}),I.jsx("div",{className:"text-gray-600 text-sm font-medium",children:s.label})]},s.label))})})}),I.jsx("section",{className:"bg-gray-50 py-20",children:I.jsxs("div",{className:"max-w-6xl mx-auto px-4",children:[I.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-12 text-center",children:"Our Scientific Approach"}),I.jsxs("div",{className:"grid md:grid-cols-3 gap-10",children:[I.jsxs("div",{className:"bg-white rounded-lg shadow p-8 flex flex-col items-center text-center",children:[I.jsx("div",{className:"text-blue-600 text-4xl mb-4",children:"🔬"}),I.jsx("h3",{className:"text-xl font-semibold mb-2",children:"Research-Driven"}),I.jsx("p",{className:"text-gray-600",children:"Our strategies are built on rigorous research, blending financial theory with modern data science and continuous innovation."})]}),I.jsxs("div",{className:"bg-white rounded-lg shadow p-8 flex flex-col items-center text-center",children:[I.jsx("div",{className:"text-blue-600 text-4xl mb-4",children:"📊"}),I.jsx("h3",{className:"text-xl font-semibold mb-2",children:"Advanced Analytics"}),I.jsx("p",{className:"text-gray-600",children:"We leverage machine learning, big data, and proprietary algorithms to identify market inefficiencies and generate alpha."})]}),I.jsxs("div",{className:"bg-white rounded-lg shadow p-8 flex flex-col items-center text-center",children:[I.jsx("div",{className:"text-blue-600 text-4xl mb-4",children:"🛡️"}),I.jsx("h3",{className:"text-xl font-semibold mb-2",children:"Risk Management"}),I.jsx("p",{className:"text-gray-600",children:"Sophisticated risk controls and real-time analytics ensure consistent performance and capital protection across market conditions."})]})]})]})})]}),NR=()=>I.jsxs("div",{className:"bg-white",children:[I.jsxs("div",{className:"relative bg-gray-900 text-white",children:[I.jsx("div",{className:"absolute inset-0",children:I.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-blue-900 to-gray-900 mix-blend-multiply"})}),I.jsxs("div",{className:"relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8",children:[I.jsx("h1",{className:"text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl",children:"About KTZ"}),I.jsx("p",{className:"mt-6 text-xl max-w-3xl",children:"Pioneering the future of quantitative investing through innovation, transparency, and excellence."})]})]}),I.jsx("div",{className:"py-16 bg-white",children:I.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:I.jsxs("div",{className:"lg:text-center",children:[I.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-8",children:"Our Mission"}),I.jsx("p",{className:"mt-4 max-w-2xl text-xl text-gray-600 lg:mx-auto",children:"To deliver superior risk-adjusted returns through innovative quantitative strategies while maintaining the highest standards of transparency and client service."})]})})}),I.jsx("div",{className:"bg-gray-50 py-16",children:I.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[I.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-12 text-center",children:"Our Values"}),I.jsxs("div",{className:"grid grid-cols-1 gap-8 md:grid-cols-3",children:[I.jsxs("div",{className:"p-6 bg-white rounded-lg shadow-sm",children:[I.jsx("h3",{className:"text-xl font-semibold text-gray-900 mb-4",children:"Innovation"}),I.jsx("p",{className:"text-gray-600",children:"We continuously push the boundaries of quantitative finance, leveraging cutting-edge technology and research to identify new opportunities."})]}),I.jsxs("div",{className:"p-6 bg-white rounded-lg shadow-sm",children:[I.jsx("h3",{className:"text-xl font-semibold text-gray-900 mb-4",children:"Transparency"}),I.jsx("p",{className:"text-gray-600",children:"We believe in clear communication and full disclosure, ensuring our clients understand our strategies and performance."})]}),I.jsxs("div",{className:"p-6 bg-white rounded-lg shadow-sm",children:[I.jsx("h3",{className:"text-xl font-semibold text-gray-900 mb-4",children:"Excellence"}),I.jsx("p",{className:"text-gray-600",children:"We maintain the highest standards in everything we do, from research and development to client service and risk management."})]})]})]})}),I.jsx("div",{className:"py-16 bg-white",children:I.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:I.jsxs("div",{className:"lg:text-center",children:[I.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-8",children:"Our Journey"}),I.jsxs("div",{className:"mt-8 space-y-8",children:[I.jsxs("div",{className:"relative pl-8 border-l-2 border-blue-500",children:[I.jsx("div",{className:"absolute -left-2 top-0 w-4 h-4 bg-blue-500 rounded-full"}),I.jsx("h3",{className:"text-xl font-semibold text-gray-900",children:"2023"}),I.jsx("p",{className:"mt-2 text-gray-600",children:"Founded with a vision to revolutionize quantitative investing through advanced machine learning and big data analytics."})]}),I.jsxs("div",{className:"relative pl-8 border-l-2 border-blue-500",children:[I.jsx("div",{className:"absolute -left-2 top-0 w-4 h-4 bg-blue-500 rounded-full"}),I.jsx("h3",{className:"text-xl font-semibold text-gray-900",children:"2024"}),I.jsx("p",{className:"mt-2 text-gray-600",children:"Launched our flagship quantitative strategy, combining traditional financial theory with modern data science."})]})]})]})})})]}),LR=()=>{const s=[{name:"Pippin Kantakom",title:"Managing Partner",bio:"",image:"https://via.placeholder.com/400x400"},{name:"Albert Tsao",title:"Managing Partner",bio:"",image:"https://via.placeholder.com/400x400"},{name:"Ben Zhou",title:"Managing Partner",bio:"",image:"https://via.placeholder.com/400x400"},{name:"Tristan Furlow",title:"Senior Partner",bio:"",image:"https://via.placeholder.com/400x400"}],e=s.filter(r=>r.title==="Managing Partner"),i=s.filter(r=>r.title==="Senior Partner");return I.jsxs("div",{className:"bg-white",children:[I.jsxs("div",{className:"relative bg-gray-900 text-white",children:[I.jsx("div",{className:"absolute inset-0",children:I.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-blue-900 to-gray-900 mix-blend-multiply"})}),I.jsxs("div",{className:"relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8",children:[I.jsx("h1",{className:"text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl",children:"Our Team"}),I.jsx("p",{className:"mt-6 text-xl max-w-3xl",children:"Meet the experts behind our innovative quantitative strategies."})]})]}),I.jsx("div",{className:"py-16 bg-white",children:I.jsxs("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:[I.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-12 mb-12",children:e.map((r,l)=>I.jsxs("div",{className:"bg-gray-50 rounded-lg overflow-hidden shadow-sm",children:[I.jsx("div",{className:"aspect-w-1 aspect-h-1",children:I.jsx("img",{src:r.image,alt:r.name,className:"w-full h-64 object-cover"})}),I.jsxs("div",{className:"p-6",children:[I.jsx("h3",{className:"text-xl font-semibold text-gray-900",children:r.name}),I.jsx("p",{className:"mt-1 text-blue-600",children:r.title}),I.jsx("p",{className:"mt-4 text-gray-600",children:r.bio})]})]},l))}),I.jsx("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-12",children:i.map((r,l)=>I.jsxs("div",{className:"bg-gray-50 rounded-lg overflow-hidden shadow-sm md:col-start-2",children:[I.jsx("div",{className:"aspect-w-1 aspect-h-1",children:I.jsx("img",{src:r.image,alt:r.name,className:"w-full h-64 object-cover"})}),I.jsxs("div",{className:"p-6",children:[I.jsx("h3",{className:"text-xl font-semibold text-gray-900",children:r.name}),I.jsx("p",{className:"mt-1 text-blue-600",children:r.title}),I.jsx("p",{className:"mt-4 text-gray-600",children:r.bio})]})]},l))})]})}),I.jsx("div",{className:"bg-gray-50 py-16",children:I.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:I.jsxs("div",{className:"text-center",children:[I.jsx("h2",{className:"text-3xl font-bold text-gray-900 mb-8",children:"Join Our Team"}),I.jsx("p",{className:"mt-4 max-w-2xl text-xl text-gray-600 mx-auto",children:"We're always looking for talented individuals who share our passion for innovation and excellence."}),I.jsx("div",{className:"mt-8",children:I.jsx("a",{href:"/contact",className:"inline-block bg-blue-600 text-white py-3 px-8 rounded-md font-medium hover:bg-blue-700 transition-colors",children:"Get in Touch"})})]})})})]})},OR=()=>I.jsxs("div",{className:"bg-white",children:[I.jsxs("div",{className:"relative bg-gray-900 text-white",children:[I.jsx("div",{className:"absolute inset-0",children:I.jsx("div",{className:"absolute inset-0 bg-gradient-to-r from-blue-900 to-gray-900 mix-blend-multiply"})}),I.jsxs("div",{className:"relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8",children:[I.jsx("h1",{className:"text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl",children:"Contact Us"}),I.jsx("p",{className:"mt-6 text-xl max-w-3xl",children:"Get in touch with our team to learn more about our investment strategies and opportunities."})]})]}),I.jsx("div",{className:"py-16 bg-white",children:I.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:I.jsxs("div",{className:"grid grid-cols-1 gap-12 lg:grid-cols-2",children:[I.jsxs("div",{children:[I.jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-8",children:"Send us a message"}),I.jsxs("form",{className:"space-y-6",children:[I.jsxs("div",{children:[I.jsx("label",{htmlFor:"name",className:"block text-sm font-medium text-gray-700",children:"Name"}),I.jsx("input",{type:"text",id:"name",name:"name",className:"mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"})]}),I.jsxs("div",{children:[I.jsx("label",{htmlFor:"email",className:"block text-sm font-medium text-gray-700",children:"Email"}),I.jsx("input",{type:"email",id:"email",name:"email",className:"mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"})]}),I.jsxs("div",{children:[I.jsx("label",{htmlFor:"subject",className:"block text-sm font-medium text-gray-700",children:"Subject"}),I.jsx("input",{type:"text",id:"subject",name:"subject",className:"mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"})]}),I.jsxs("div",{children:[I.jsx("label",{htmlFor:"message",className:"block text-sm font-medium text-gray-700",children:"Message"}),I.jsx("textarea",{id:"message",name:"message",rows:4,className:"mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500"})]}),I.jsx("div",{children:I.jsx("button",{type:"submit",className:"w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors",children:"Send Message"})})]})]}),I.jsxs("div",{children:[I.jsx("h2",{className:"text-2xl font-bold text-gray-900 mb-8",children:"Office Information"}),I.jsxs("div",{className:"space-y-8",children:[I.jsxs("div",{children:[I.jsx("h3",{className:"text-lg font-medium text-gray-900",children:"New York Office"}),I.jsxs("p",{className:"mt-2 text-gray-600",children:["350 Fifth Avenue",I.jsx("br",{}),"New York, NY 10118",I.jsx("br",{}),"United States"]})]}),I.jsxs("div",{children:[I.jsx("h3",{className:"text-lg font-medium text-gray-900",children:"Contact Details"}),I.jsxs("p",{className:"mt-2 text-gray-600",children:["Email: info@ktz.com",I.jsx("br",{}),"Phone: +1 (212) 555-0123"]})]}),I.jsxs("div",{children:[I.jsx("h3",{className:"text-lg font-medium text-gray-900",children:"Business Hours"}),I.jsxs("p",{className:"mt-2 text-gray-600",children:["Monday - Friday: 9:00 AM - 6:00 PM EST",I.jsx("br",{}),"Saturday - Sunday: Closed"]})]})]})]})]})})})]});function PR(){return I.jsx(qy,{children:I.jsx(My,{children:I.jsxs(ys,{path:"/",element:I.jsx(iM,{}),children:[I.jsx(ys,{index:!0,element:I.jsx(UR,{})}),I.jsx(ys,{path:"about",element:I.jsx(NR,{})}),I.jsx(ys,{path:"team",element:I.jsx(LR,{})}),I.jsx(ys,{path:"contact",element:I.jsx(OR,{})})]})})})}RS.createRoot(document.getElementById("root")).render(I.jsx(he.StrictMode,{children:I.jsx(PR,{})}));
